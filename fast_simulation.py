...
def run_fast_simulation(xdata=np.array([0,1]), n1=1.6, n2=1, detector_distance=7.5,
                        detector_window=0.3, detector_steps=200, n_rays=5*10**7, logging=True):
    """Run fast simulation.
    ...
    if logging:
        ...
        plt.grid()
        plt.plot(angular_positions, bins_intensity, 'x', label="Intensity")
        plt.legend()
